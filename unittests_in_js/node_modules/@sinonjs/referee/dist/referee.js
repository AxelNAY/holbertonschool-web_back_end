(() => {
  ...
  var require_create_add = __commonJS((exports, module) => {
    ...
    function verifyArguments(name, options) {
      ...
      if (typeof options.assertMessage !== "string" || options.assertMessage.length === 0) {
        throw new TypeError("'assertMessage' option must be a non-empty String");
      }
      if (typeof options.refuteMessage !== "string" || options.refuteMessage.length === 0) {
        throw new TypeError("'refuteMessage' option must be a non-empty String");
      }
    }
